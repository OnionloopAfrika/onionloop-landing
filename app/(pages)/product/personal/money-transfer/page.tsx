import { LinkCircle, SafeIcon, TimerIcon } from '@/app/components/icons/svgs';
...
const page = () => {
    ...
    const bankTransferGrid = {
        title: "Easily Link Your Bank for Transfers",
        description: "Transfer money directly to and from your bank account. Fast, secure, and fully encrypted connections to thousands of banks.",
        features: [
            {
                icon: <LinkCircle />,
                title: "Instant Bank Links",
                description: "Connect your bank account in seconds using secure verification — fast, safe, and hassle-free."
            },
            {
                icon: <TimerIcon />,
                title: "Same-Day Transfers",
                description: "Money arrives in your bank account the same day. No more waiting 3-5 business days."
            },
            {
                icon: <SafeIcon />,
    ...
    return (
        <div className="w-full">
            ...
            {/* ========================================================================= */}
            <FeatureSection heroData={bankTransferHero} gridData={bankTransferGrid} />;
