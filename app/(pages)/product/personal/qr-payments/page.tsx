import { BellIcon, QrIcon, SafeIcon } from '@/app/components/icons/svgs';
...
const page = () => {
    ...
    const gridData: FeatureGridData = {
        title: "Instant Person - to - Person Payments",
        description: "Send and receive money in seconds. No complicated bank details, no hidden fees. Just simple, secure payments within your trusted network.",
        features: [
            {
                icon: <QrIcon />,
