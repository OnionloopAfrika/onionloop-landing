import { BellIcon, GiftIcon, OnionCoins } from '@/app/components/icons/svgs';
...
const page = () => {
    ...
    const onionCoinsGrid = {
        title: "Get Rewarded For Every Payment",
        description: "Earn points with every transaction. Redeem for cash back, exclusive perks, and partner rewards",
        features: [
            {
                icon: <OnionCoins />,
                title: "Onioncoins",
                description: "OnionCoins are rewards you earn when you use Onionloop for any transactions."
            },
            {
                icon: <GiftIcon />,
                title: "Earn OnionCoins",
                description: "Use OnionCoins for cashback, airtime, or discounts at supermarkets and stores that uses Onionloop."
            },
            {
                icon: <BellIcon />,
                title: "Real-Time Notifications",
                description: "Stay updated instantly when you get rewarded with your Onioncoins."
            }
        ]
    };
    return (
        <div className="w-full">
            ...
            {/* ========================================================================= */}
            <FeatureSection heroData={onionCoinsHero} gridData={onionCoinsGrid} />;
        </div>
    )
}
