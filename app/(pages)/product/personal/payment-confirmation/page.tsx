import { CashIcon, CashWithdraw, SafeIcon } from '@/app/components/icons/svgs';
...
const page = () => {
    ...
    return (
        <div className="w-full">
            <div className="w-full py-16 md:py-24 px-4 md:px-6 about-gradient min-h-[60dvh] flex items-center justify-center">
                ...
                <div className="w-full max-w-2xl mx-auto flex flex-col items-center justify-center text-center gap-6">
                    ...
                    <h1 className="text-5xl font-bold text-black">
                        Deposit and withdraw cash <span className="text-[#04907E]">securely</span>
                    </h1>
            ...
            {/* ========================================================================= */}
            <FeatureSection heroData={cashServicesHero} gridData={cashServicesGrid} />;
